...
pub struct Color2D{
    //webglprogram = shaders + buffering
...
impl Color2D{
    pub fn new(gl: &WebGlRenderingContext) -> Self{
        //super refers to parents directory
        //SHADER refers to source code contained within the shader file
        ...
        //draw coordinates of triangle in counter-clockwise
        ...
        //buffers with webGL are memory locations that are very close to the GPU
